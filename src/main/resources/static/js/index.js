...
function addPush() {
    if (!pushFlag) {
        $(".layui-flow-more").before(
            '<div id="refresh_float_click" class="msg-alert msg-alert-fixed"><span>您有未读新闻，点击刷新</span> <i\n' +
...
$("#home-list").on("click", "#refresh_float_click", function () {
    pushFlag = false;
    $("#refresh_float_click").remove()
    setTimeout(function () {
