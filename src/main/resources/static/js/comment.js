        ...
        if (cmt != null && cmt != "") {
            if (commentId == 0) {
                $(".cy-cmt-list").prepend(
                    ...
                    '                                        <img src="//sucimg.itc.cn/avatarimg/10101371442733_1543997437371_c55" alt="">\n' +
                    '                                    </a>\n' +
                    '                                    <div class="cmt-content">\n' +
                    '                                        <div class="cmt-user-info">\n' +
                    '                                            <div>\n' +
                    '                                                <a href="" target="_blank" class="cmt-user-name">笑一切</a>\n' +
                    '                                                <span class="cmt-user-ip"></span>\n' +
                    '                                            </div>\n' +
                    '                                            <span class="cmt-create-time">2018-12-10 12:11:30</span>\n' +
                    '                                        </div>\n' +
                    '                                        <p class="cmt-msg">' + AnalyticEmotion(cmt) + '</p>\n' +
                    '                                        <div class="cmt-footer-action">\n' +
                    '                                            <div class="action-left">\n' +
                    '                                                <a id="3" class="cmt-reply click_reply_comment">回复</a>\n' +
                    '                                            </div>\n' +
                ...
                $("#" + commentId).parent().parent().next().prepend(
                    ...
                    '                                                <a href="" class="avatar-wrap">\n' +
                    '                                                    <img src="//sucimg.itc.cn/avatarimg/10101371442733_1543997437371_c55"\n' +
                    '                                                         alt="">\n' +
                    '                                                </a>\n' +
                    '                                                <div class="cmt-content">\n' +
                    '                                                    <div class="cmt-user-info">\n' +
                    '                                                        <div>\n' +
                    '                                                            <a href="" target="_blank" class="cmt-user-name">笑一切</a>\n' +
                    '                                                            <span class="cmt-user-ip">[四川省成都市网友]</span>\n' +
                    '                                                        </div>\n' +
                    '                                                        <span class="cmt-create-time">5天前</span>\n' +
                    '                                                    </div>\n' +
                    '                                                    <p class="cmt-msg">' + AnalyticEmotion(cmt) + '</p>\n' +
                    '                                                    <div class="cmt-footer-action">\n' +
                    '                                                        <div class="action-left">\n' +
                    '                                                            <a id="10" class="cmt-reply click_reply_comment">回复</a>\n' +
                    '                                                            <a class=" click_expand_reply">&nbsp;⋅&nbsp;<span class="c-reply-count">4</span>条回复</a>\n' +
                    '                                                            <i class="layui-icon layui-icon-down cmt-i-r reply-list"></i>\n' +
                    '                                                        </div>\n' +
                    '                                                        <div class="action-right">\n' +
                    '\n' +
                    '                                                            <span title="点赞" class="bui-right c-digg">47</span>\n' +
